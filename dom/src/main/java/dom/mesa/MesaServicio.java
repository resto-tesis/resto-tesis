...
public class MesaServicio extends AbstractFactoryAndRepository {
	...
	public List<Mesa> listarMesas() {
		if(Usuario.class.equals("Mozo-role") == getContainer().getUser().hasRole("Mozo-role")){
			final List<Mesa> lmasignadas = allMatches(new QueryDefault<Mesa>(Mesa.class, "mesasAsignadas"));
			return lmasignadas;
		}else{
