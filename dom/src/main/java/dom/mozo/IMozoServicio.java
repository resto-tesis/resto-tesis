...
public interface IMozoServicio {
	public String validateCrearMozo(final String _nombre, final String _apellido, final long _dni, final LocalDate fechadeNacimiento, final LocalDate fechadeIngreso);
